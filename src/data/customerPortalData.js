...
export const customerCategories = [
  ...
  { name: 'Electronics', accent: '#406F60', count: '860 items' },
  { name: 'Home Living', accent: '#D0A86E', count: '530 items' },
  { name: 'Beauty', accent: '#8C6B5A', count: '420 items' },
  { name: 'Wellness', accent: '#759B8C', count: '310 items' },
  { name: 'Accessories', accent: '#678E80', count: '290 items' },
];
...
export const recommendedProducts = [
  ...
  { id: 2, name: 'Organic Pantry Box', category: 'Groceries', price: 29, rating: 4.9, reviews: 521, supplier: 'Fresh Basket', badge: 'Top Rated', accent: '#406F60' },
  { id: 3, name: 'Luma Desk Lamp', category: 'Home Living', price: 49, rating: 4.7, reviews: 194, supplier: 'Urban Home', badge: 'Eco Saver', accent: '#D0A86E' },
  { id: 4, name: 'Pure Mist Diffuser', category: 'Wellness', price: 39, rating: 4.6, reviews: 166, supplier: 'Calm Collective', badge: 'Wellness', accent: '#759B8C' },
];
...
export const trendingProducts = [
  ...
  { id: 6, name: 'Harvest Blend Coffee', category: 'Groceries', price: 18, originalPrice: 24, rating: 4.7, reviews: 410, supplier: 'Bean Theory', badge: 'Best Deal', accent: '#406F60' },
  { id: 7, name: 'Cloud Weave Throw', category: 'Home Living', price: 56, originalPrice: 79, rating: 4.8, reviews: 204, supplier: 'House Foundry', badge: 'Limited', accent: '#D0A86E' },
  { id: 8, name: 'Glow Skin Serum', category: 'Beauty', price: 42, originalPrice: 52, rating: 4.6, reviews: 300, supplier: 'Aster Care', badge: 'Trending', accent: '#8C6B5A' },
  { id: 9, name: 'MoveFit Bottle', category: 'Accessories', price: 22, originalPrice: 30, rating: 4.8, reviews: 115, supplier: 'Active Loop', badge: 'Popular', accent: '#678E80' },
  { id: 10, name: 'Sleep Calm Tea', category: 'Wellness', price: 15, originalPrice: 19, rating: 4.5, reviews: 97, supplier: 'Herbal Hour', badge: 'New', accent: '#759B8C' },
];

export const bestDeals = [
  { title: 'Weekend essentials', subtitle: 'Up to 30% off groceries and wellness kits', code: 'WEEKEND30', accent: '#1F5C4A' },
  { title: 'Smart home edit', subtitle: 'Instant cashback on connected home products', code: 'HOMEPAY', accent: '#406F60' },
  { title: 'Rewards booster', subtitle: '2x loyalty points on orders above $120', code: 'POINTS2X', accent: '#D0A86E' },
];

export const recentlyViewed = [
  { id: 11, name: 'Stoneware Mug Set', category: 'Home Living', price: 34, rating: 4.6, reviews: 76, supplier: 'Clayline', accent: '#8C6B5A' },
  { id: 12, name: 'Cold Press Juice Pack', category: 'Groceries', price: 21, rating: 4.7, reviews: 118, supplier: 'Daily Press', accent: '#406F60' },
